    ...
    <form action="{{ route('post.store') }}" method="POST">
            ...
            <div class="border-b border-white/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <input id="title" type="text" name="title" autocomplete="title" class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-white sm:text-sm/6" />
                            @error('title')
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea id="content" name="content" rows="8" class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-white sm:text-sm/6"></textarea>
                        </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button type="submit" name="action" value="save"
                class="cursor-pointer rounded-md px-3 py-2 text-sm font-semibold text-white">
                Save
            </button>
